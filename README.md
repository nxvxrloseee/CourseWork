...
Пояснилка и приложения (А — текст программы, Б — сценарии тестов, Г — РП, Д — скрипт БД, Е — входные/выходные, Ж — целостность) лежат отдельно в `Documents/3.2 course/CW/Доки/`.
